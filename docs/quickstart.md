...
Sign up at [app.devplan.com](https://app.devplan.com) with Google SSO or a magic link. Add context and integrations early for better [Today](/today), [Insights](/insights), and [Ask Devplan](/ask-devplan) output.
...
This is the most important step. Open **Knowledge > Integrations** and connect the tools your team already uses.

| Start here | Why |
|------------|-----|
| **GitHub** or **Bitbucket** | Code analysis and feature catalog bootstrap |
| **Slack** | Discussion signals (invite the Devplan bot to channels) |
| **Jira** or **Linear** | Tickets and delivery context |
| **Confluence**, **Notion**, or **Google Drive** | Docs and specs |
| **Upload files** | Research, decks, and exports not in another tool |

Connecting is not enough for most providers — also **Configure**, **Attach**, or **Select folders** so Devplan knows what to read. See [Integrations overview](/integrations-overview) for setup guides.

### Processing time

Background jobs need time to ingest data.

| Source | Typical wait |
|--------|--------------|
| Code repos | **30+ minutes** for first analysis and catalog bootstrap |
